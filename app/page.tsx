        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6">
            <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-white text-sm font-medium mb-8 animate-fade-in">
              <Image src="/logo.png" alt="Egypt Explorer Logo" width={16} height={16} className="w-4 h-4 object-contain brightness-0 invert" unoptimized />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {EGYPT_HIGHLIGHTS.map((h) => (
                <div key={h.title} className={`border rounded-2xl p-6 bg-gradient-to-br ${h.color} hover:scale-[1.02] transition-transform cursor-default`}>
